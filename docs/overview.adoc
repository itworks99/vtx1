...
- **Input Thresholds**: VIL = 0.5V max, VIH = 4.5V min
- **Implementation**: 5V-compatible using standard CMOS level shifters
- **ESD Protection**: 2kV HBM, 200V MM for 5V-tolerant operation
...
- **PMOS Devices:** W/L = 20μm/0.18μm (high drive strength)
- **NMOS Devices:** W/L = 10μm/0.18μm (matched conductance)
- **Level Decoders:** W/L = 5μm/0.18μm (low power)
...
- **Power Consumption:** 25mW active, 100μW standby
