...
....
{
  signal: [
    ...
    {name: 'CPU (100 MHz)', wave: 'p................'},
    {name: 'Memory (100 MHz)', wave: 'p................'},
    {name: 'Peripheral (50 MHz)', wave: 'P................'},
...
* Power Sequencing
* Power-Up: 1.1 ms + 8 cycles
* Power-Down: 1.1 ms + 12 cycles
* Brown-out Detection: 1 μs
...
{
  signal: [
    {name: 'CPU Clock (100 MHz)', wave: 'p..........'},
    {name: 'Memory Clock (100 MHz)', wave: 'p..........'},
    {name: 'Peripheral Clock (50 MHz)', wave: 'P..........'},
    {name: 'Debug Clock (25 MHz)', wave: 'n..........'},
    {},
...
* Memory Clock: 100 MHz max
* Peripheral Clock: 50 MHz max
* Debug Clock: 25 MHz max
* Clock Jitter: < 100ps
* Clock Skew: < 100ps
* Duty Cycle: 50% ± 5%
